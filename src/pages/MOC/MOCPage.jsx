  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <SummaryCard label="Vessel MOC tasks" value="1" tone="info" />
        <SummaryCard label="Ready ship review" value="1" tone="warning" borderLeft="amber" />
        <SummaryCard label="Returned" value="1" tone="critical" borderLeft="red" />
        <SummaryCard label="Closed YTD" value="31" tone="healthy" />
      </div>
