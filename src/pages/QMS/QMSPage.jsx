...
export const qhseDeviationsCatalog = tablesData.deviationsCatalog;
...
export default function QMSPage() {
  ...
  const filteredData = useMemo(() => {
    return qhseDeviationsCatalog.filter((d) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <PageHeader
          title="QHSE"
          description="Quality, health, safety and environment overview: deviations, risk, drills and audits."
          actions={
            <>
